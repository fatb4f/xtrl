...
```json
{
  ...
  "contract_path": "$CODEX_STATE/xtrl/packets/engineering/pkt-exec-0003-enforce-allowed-paths-during-execution/contract.json",
  "worktree_root": "$CODEX_STATE/xtrl/worktrees/pkt-exec-0003-enforce-allowed-paths-during-execution/",
  "tasks": [
    "<task 1>",
    "<task 2>"
  ],
