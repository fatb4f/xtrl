...
```json
{
  ...
  "contract_path": "$CODEX_STATE/xtrl/packets/engineering/pkt-ops-0023-gate-target-dispatch/contract.json",
  "worktree_root": "$CODEX_STATE/xtrl/worktrees/pkt-ops-0023-gate-target-dispatch/",
  "tasks": [
    "<task 1>",
    "<task 2>"
  ],
