...
```json
{
  ...
  "contract_path": "$CODEX_STATE/xtrl/packets/engineering/pkt-evidence-0003-align-evidence-json-with-v0-2-schema/contract.json",
  "worktree_root": "$CODEX_STATE/xtrl/worktrees/pkt-evidence-0003-align-evidence-json-with-v0-2-schema/",
  "tasks": [
    "<task 1>",
    "<task 2>"
  ],
