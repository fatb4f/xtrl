...
```json
{
  ...
  "contract_path": "$CODEX_STATE/xtrl/packets/engineering/pkt-exec-0002-enforce-budgets-time-diff-iteration/contract.json",
  "worktree_root": "$CODEX_STATE/xtrl/worktrees/pkt-exec-0002-enforce-budgets-time-diff-iteration/",
  "tasks": [
    "<task 1>",
    "<task 2>"
  ],
