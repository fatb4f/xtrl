...
def find_out_dir(packet_id: str, state_root: Path) -> Optional[Path]:
...
def legacy_out_dir(packet_id: str, state_root: Path) -> Path:
    return (state_root / "out" / packet_id).resolve()
